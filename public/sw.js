// Minimal service worker for Nestling PWA.
// Strategy: network-first for navigations (so logs stay fresh), with an
// offline fallback to a cached shell; cache-first for static assets.

const CACHE = "nestling-v1";
